...
for those wishing to customize this bot, have fun with this. just be sure to not alter the keys
"""

helpText = {
    # for music related commands

    'clearBrief': 'Clear queue',
    'clearDesc': 'Clears the entire queue. Use with caution, you might lose aux cord privileges.',

    'leaveBrief': 'Leaves voice channel.',
    'leaveDesc': 'If I am in a call, I leave. The queue is cleared.',

    'nowplayingBrief': 'Song that is currently playing.',
    ...
    'wisdomDesc': 'The world is an odd place. A word of advice from your beloved bot, TedTunes :).'

    # this bot was made & hosted by teddy#5014.
